            ...
            <div className='container nav-container'>
              <ul className='navbar-nav ml-auto mb-2 mb-lg-0 align-items-lg-center d-flex'>
                ...
                <li className='mr-lg-3 nav-item dropdown' id='lang-dropdown'>
                  <button className='language-dropdown d-flex align-items-center justify-content-between' id='navbarDropdown' type='button' onClick={() => setDropdown(!dropdown)} data-bs-toggle='dropdown' aria-expanded='false'>
                  ...
                  <ul className={`dropdown-menu mb-screen ${dropdown ? 'show' : ''}`} id='dropdown-menu' aria-labelledby='navbarDropdown'>
                    <li>
